...
- [`merge_headers()`](https://nouredindarwish.github.io/xtra/reference/merge_headers.html)
  merges header cells through compatible blank rows in flextables created
  from gtsummary objects.
